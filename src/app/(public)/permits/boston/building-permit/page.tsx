  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" style={{ background: '#0F172A', minHeight: '100vh' }}>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Boston ISD — Key Contacts</h2>
      ...
      {/* Pro Tips */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Pro Tips for Boston Developers</h2>
