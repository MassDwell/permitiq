    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="flex items-center gap-1.5 text-sm text-gray-500 mb-8">
          ...
          <span>Boston</span>
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-gray-900">Article 80 Review</span>
        </nav>
        ...
        <div className="mb-10 bg-green-50 border border-green-200 rounded-2xl p-5">
          <div className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
            <div>
              <p className="font-semibold text-gray-900">July 2025 — Article 80 Modernization</p>
              ...
              <a
                ...
                className="inline-flex items-center gap-1 text-sm text-green-700 font-medium hover:underline mt-2"
                target="_blank"
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">When Does Article 80 Apply?</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="border-2 border-blue-200 bg-blue-50 rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-3">
                <span className="bg-blue-600 text-white text-xs font-bold px-2.5 py-1 rounded-full">LARGE</span>
                <p className="font-semibold text-gray-900">Large Project Review</p>
              </div>
              ...
              <div className="mt-4 bg-white rounded-xl p-3 border border-blue-200">
                <p className="text-xs font-semibold text-blue-700">Typical Timeline</p>
            ...
            <div className="border-2 border-gray-200 bg-gray-50 rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-semibold text-gray-900">Small Project Review</p>
              </div>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
              ...
              <div className="mt-4 bg-white rounded-xl p-3 border border-gray-200">
                <p className="text-xs font-semibold text-gray-600">Typical Timeline</p>
                <p className="text-lg font-bold text-gray-900">3–6 months</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Large Project Review: 5-Step Process</h2>
          ...
          <div className="space-y-6">
            {LARGE_PROJECT_STEPS.map((step) => (
              <div key={step.step} className="border border-gray-200 rounded-2xl overflow-hidden">
                <div className="flex items-center gap-4 bg-gray-50 border-b border-gray-200 px-6 py-4">
                  ...
                  <span className="text-xs font-medium bg-white border border-gray-200 text-gray-600 px-3 py-1.5 rounded-full flex-shrink-0">
                    {step.duration}
                  </span>
                </div>
                <div className="px-6 py-4 space-y-3">
                  ...
                  <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
                    ...
                    <p className="text-sm text-amber-800"><strong>Developer Tip:</strong> {step.tips}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {LARGE_REVIEW_AREAS.map((area) => {
              ...
              return (
                <div key={area.label} className="border border-gray-200 rounded-xl p-4">
                  <Icon className="h-5 w-5 text-blue-500 mb-2" />
                  <p className="font-semibold text-gray-900 text-sm">{area.label}</p>
                  <p className="text-xs text-gray-500 mt-0.5">{area.detail}</p>
                </div>
              );
            })}
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Small Project Review</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Timeline Reality Check</h2>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-1.5 text-sm text-gray-700">
                  <li className="flex items-center gap-2">
                    <span className="w-24 text-xs font-semibold text-gray-500 uppercase tracking-wide flex-shrink-0">LOI → PNF</span>
                    <span>4–8 weeks</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-24 text-xs font-semibold text-gray-500 uppercase tracking-wide flex-shrink-0">PNF Review</span>
                    <span>2–4 months (incl. 30-day public comment)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-24 text-xs font-semibold text-gray-500 uppercase tracking-wide flex-shrink-0">DPIR (if req.)</span>
                    <span>3–6 months</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-24 text-xs font-semibold text-gray-500 uppercase tracking-wide flex-shrink-0">FPIR (if req.)</span>
                    <span>2–4 months</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-24 text-xs font-semibold text-gray-500 uppercase tracking-wide flex-shrink-0">Board Vote</span>
        ...
        {/* Contact */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Contact Boston Planning Department</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="border border-gray-200 rounded-xl p-5">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Article 80 Inquiries</p>
              <a href="mailto:article80inquiries@boston.gov" className="font-semibold text-blue-600 hover:underline">
                article80inquiries@boston.gov
              </a>
              <p className="text-sm text-gray-500 mt-1">For project-specific questions before filing LOI</p>
            </div>
            <div className="border border-gray-200 rounded-xl p-5">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">BPDA Development Review</p>
              <a
                href="http://www.bostonplans.org/projects/development-review/what-is-article-80"
              ...
              <p className="text-sm text-gray-500 mt-1">Full Article 80 guidance, templates, and active projects</p>
            </div>
          </div>
        </section>
