    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" style={{ background: '#080D1A', minHeight: '100vh' }}>
        ...
        <nav className="flex items-center gap-1.5 text-sm text-[#64748B] mb-8">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-white">ADU Permit</span>
        </nav>
        ...
        <div className="mb-10">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-[#14B8A6]">Massachusetts Permit Guide</span>
          </div>
        ...
        <section className="mb-10">
          <div className="bg-[rgba(20,184,166,0.08)] border border-[rgba(20,184,166,0.25)] rounded-2xl p-6">
            <div className="flex items-start gap-3">
              <MapPin className="h-5 w-5 text-[#14B8A6] mt-0.5 flex-shrink-0" />
              <div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-[#111827] border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-sm text-[#64748B]">
              ...
              See our{" "}
              <Link href="/permits/boston/zba-variance" className="text-[#14B8A6] hover:underline">
                ZBA Variance Guide
              </Link>{" "}
        ...
        {/* Permit Requirements */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">Permit Requirements</h2>
        ...
        {/* Fees by City */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-2">ADU Permit Fees by City</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {CITY_ADU_RULES.map((city) => (
              <div key={city.city} className="border border-white/10 rounded-xl p-5">
                <div className="flex items-center justify-between mb-2">
                  <p className="font-semibold text-white">{city.city}</p>
                  <span className="text-xs font-medium bg-green-900/20 text-green-400 px-2 py-0.5 rounded-full">
                    {city.status}
                  </span>
                </div>
                <p className="text-sm text-[#94A3B8] mb-3">{city.detail}</p>
                <div className="flex items-center gap-1.5 text-sm">
                  <DollarSign className="h-4 w-4 text-[#64748B]" />
                  <span className="font-medium text-[#94A3B8]">{city.fee}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Timeline */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-2">Typical ADU Timeline</h2>
          <p className="text-[#94A3B8] mb-5">
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-white/6">
                {TIMELINE_PHASES.map((phase) => (
                  <tr key={phase.phase}>
                    <td className="px-5 py-3 font-medium text-white text-sm">{phase.phase}</td>
                    <td className="px-5 py-3">
                      <span className="text-xs font-medium bg-[rgba(20,184,166,0.08)] text-[#14B8A6] px-2.5 py-1 rounded-full">
                        {phase.weeks} wks
                      </span>
                    </td>
                    <td className="px-5 py-3 text-sm text-[#94A3B8] hidden sm:table-cell">{phase.detail}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-5 bg-[#111827] border border-white/10 rounded-xl p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-white">Factory-Built ADUs: Faster Construction</p>
