    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" style={{ background: '#0F172A', minHeight: '100vh' }}>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-medium text-[#14B8A6]">Somerville ISD — Developer Guide</span>
        </div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Somerville ISD — Key Contacts</h2>
      ...
      {/* Pro Tips */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Pro Tips for Somerville Developers</h2>
